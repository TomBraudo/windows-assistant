...
def main():
    ...
    registry.register("capture_screenshot", vision_tools.capture_screenshot, get_tool_description("capture_screenshot"), sensitive=False)
    registry.register("analyze_image", vision_tools.analyze_image, get_tool_description("analyze_image"), sensitive=False)
    registry.register("analyze_screenshot", vision_tools.analyze_screenshot, get_tool_description("analyze_screenshot"), sensitive=False)
    registry.register("find_ui_element", vision_tools.find_ui_element, get_tool_description("find_ui_element"), sensitive=False)
    registry.register("describe_screen", vision_tools.describe_screen, get_tool_description("describe_screen"), sensitive=False)
