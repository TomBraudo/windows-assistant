...
class PromptRefiner:
    ...
    def __init__(self, model: str = "openrouter/tngtech/deepseek-r1t2-chimera:free"):
        ...
        self.system_prompt = (
            ...
            "- Example: For 'research Kafka and create a presentation', create 2 steps:\n"
            "  Step 1: web_search for Kafka information\n"
            "  Step 2: create_presentation using the research from step 1\n"
